...
func TestBuildBacktestTradesPairsEntryAndExit(t *testing.T) {
	analysis, err := json.Marshal(strategy.Analysis{Checks: []strategy.DiagnosticCheck{
		...
		{Name: "entry_feature_snapshot", Side: strategy.SignalSideBuy, Values: map[string]string{
			"market_direction_score":              "71.4",
			"market_direction_agreement":          "85.7",
			"market_direction_conflict":           "16.7",
			"market_trend_strength":               "86.7",
			"market_momentum_strength":            "73.3",
			"market_volatility_health":            "83.3",
			"market_structure_quality":            "90",
			"market_volume_confirmation":          "80",
			"market_location_score":               "50",
			"market_risk_score":                   "10",
			"market_data_confidence":              "96.6",
			"market_score_available_features":     "28",
			"market_score_expected_features":      "29",
			"market_strength_score":               "72.7",
			"market_risk_adjusted_strength_score": "62.7",
			"market_directional_capability_score": "47.1",
			"market_score_version":                "market-capability.v2.6",
			"market_direction_bias":               "bull",
			"market_strength_state":               "strong",
		}},
	...
	for key, want := range map[string]string{
		...
		"entry_market_direction_score":              "71.4",
		"entry_market_direction_agreement":          "85.7",
		"entry_market_direction_conflict":           "16.7",
		"entry_market_trend_strength":               "86.7",
		"entry_market_momentum_strength":            "73.3",
		"entry_market_volatility_health":            "83.3",
		"entry_market_structure_quality":            "90",
		"entry_market_volume_confirmation":          "80",
		"entry_market_location_score":               "50",
		"entry_market_risk_score":                   "10",
		"entry_market_data_confidence":              "96.6",
		"entry_market_score_available_features":     "28",
		"entry_market_score_expected_features":      "29",
		"entry_market_strength_score":               "72.7",
		"entry_market_risk_adjusted_strength_score": "62.7",
		"entry_market_directional_capability_score": "47.1",
		"entry_market_score_version":                "market-capability.v2.6",
		"entry_market_direction_bias":               "bull",
		"entry_market_strength_state":               "strong",
		"mfe_bps":                                   "150",
		"mae_bps":                                   "30",
		"profit_giveback_bps":                       "50",
	} {
