...
func TestApplierOpensAndClosesPosition(t *testing.T) {
	...
	intent := execution.OrderIntent{IntentID: "i1", Scope: "paper", Exchange: "binance", Market: "um", Symbol: "ETHUSDT", StrategyName: "supertrend", PositionSide: "long", Action: execution.OrderActionOpen, BarOpenTime: 5, ExitRules: []strategy.ExitRule{{Type: strategy.ExitReasonStopLoss, TriggerPrice: "90"}}}
	...
	if got == nil || got.Size != 2 || len(got.ExitRules) != 1 || got.HighestPriceBarOpenTime != 5 || got.LowestPriceBarOpenTime != 5 {
